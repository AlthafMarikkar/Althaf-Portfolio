...
const Hero = () => {
  ...
  const socialLinks = [
    {
      icon: FaGithub,
      href: "https://github.com/AlthafMarikkar",
      label: "GitHub",
      color: "hover:text-gray-400"
    },
    {
      icon: FaLinkedin,
      href: "https://www.linkedin.com/in/althaf-marikkar-0951492b5/",
      label: "LinkedIn",
    ...
    {
      icon: FaEnvelope,
      href: "althafmarikkar2003@gmail.com",
      label: "Email",
          ...
          <div className="space-y-4 sm:space-y-6">
            ...
            >
              <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-bold leading-tight">
                <span className="gradient-text">Althaf</span>
                <br />
                <span className="text-light">Marikkar</span>
              </h1>
            </motion.div>
        ...
        >
          ...
          >
            ...
            >
              <img
                src={profileImg}
                alt="Althaf Marikkar - Full Stack Developer"
