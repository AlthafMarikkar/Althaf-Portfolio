  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const templateParams = {
        ...
        to_email: 'althafmarikkar2003@gmail.com',
      };
  ...
  const contactInfo = [
    {
      icon: FaEnvelope,
      title: "Email",
      content: "althafmarikkar2003@gmail.com",
      link: "mailto:althafmarikkar2003@gmail.com",
      color: "text-red-400"
    },
    {
      icon: FaPhone,
      title: "Phone",
      content: "+94 77 605 4074",
      link: "tel:+94776054074",
  ...
  const socialLinks = [
    {
      icon: FaGithub,
      title: "GitHub",
      link: "https://github.com/AlthafMarikkar",
      color: "hover:text-gray-400"
    },
    {
      icon: FaLinkedin,
      title: "LinkedIn",
      link: "https://www.linkedin.com/in/althaf-marikkar-0951492b5/",
